...
IF EXIST "%Product%" ( 
	call "%InstallScriptsPath%\AutoProduct.exe" "%Product%"
	call "%InstallScriptsPath%\opSQLDatabase.bat" setadmin "%testset%" "%Old_Client%_SYSTEM"
    )
ECHO ==================================================================
...
echo call "%InstallScriptsPath%\opSQLDatabase.bat" mdalias "%testset%" "%New_Client%_SYSTEM"
...
IF EXIST "%Product%" ( 
	...
	call "%InstallScriptsPath%\AutoProduct.exe" "%Product%"
	echo call "%InstallScriptsPath%\opSQLDatabase.bat" setadmin "%testset%" "%New_Client%_SYSTEM"
	call "%InstallScriptsPath%\opSQLDatabase.bat" setadmin "%testset%" "%New_Client%_SYSTEM"
)
