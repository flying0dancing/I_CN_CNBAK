...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'RegressionTests_Clean') AND type in (N'P', N'PC'))
DROP PROCEDURE RegressionTests_Clean
GO

CREATE PROCEDURE RegressionTests_Clean
